        ...
        <div className="flex">
          <div className="fixed w-2/5 px-10 mb-10 mt-5">
            <div className="relative">
              ...
              <div className={`flex flex-col border-4 absolute top-10 bottom-10 left-10 right-10 z-0 items-start justify-center border-${colour} bg-` + colour } style={{ 'paddingLeft': "55%" }}>
